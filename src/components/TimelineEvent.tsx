          ...
          >
            {isHovered ? (
              <div className="flex flex-row items-stretch">
                ...
                >
                  <motion.span
                    className="text-center text-big-margin-650 text-big-margin-760 mb-2 font-bold text-big-font-650 text-big-font-760 text-[17px] 2lg:text-lg drop-shadow-strong"
